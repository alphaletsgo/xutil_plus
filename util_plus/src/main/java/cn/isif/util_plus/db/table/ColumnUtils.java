...
package cn.isif.util_plus.db.table;
...
import cn.isif.util_plus.db.annotation.*;
import cn.isif.util_plus.db.annotation.Column;
import cn.isif.util_plus.db.annotation.Finder;
import cn.isif.util_plus.db.annotation.Foreign;
import cn.isif.util_plus.db.annotation.Id;
import cn.isif.util_plus.db.converter.ColumnConverter;
import cn.isif.util_plus.db.converter.ColumnConverterFactory;
import cn.isif.util_plus.db.sqlite.FinderLazyLoader;
import cn.isif.util_plus.db.sqlite.ForeignLazyLoader;
import cn.isif.util_plus.util.LogUtils;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(cn.isif.util_plus.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(cn.isif.util_plus.db.table.Finder finderColumn) {
