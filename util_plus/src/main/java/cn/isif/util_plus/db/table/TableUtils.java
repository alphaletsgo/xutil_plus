...
import cn.isif.util_plus.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, cn.isif.util_plus.db.table.Id> entityIdMap = new ConcurrentHashMap<String, cn.isif.util_plus.db.table.Id>();

    /* package */
    static synchronized cn.isif.util_plus.db.table.Id getId(Class<?> entityType) {
        ...
        cn.isif.util_plus.db.table.Id id = new cn.isif.util_plus.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        cn.isif.util_plus.db.table.Id id = getId(entityType);
